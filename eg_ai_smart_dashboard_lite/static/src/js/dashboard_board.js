odoo.define('eg_ai_smart_dashboard_lite.dashboard_board', function (require) {
    ...
    var CustomDashboardBoard =  Widget.extend({
        template: 'CustomDashboardBoard',

        events: {
            'click #save_dashboard': 'save_dashboard_data',
            'click #chart-type-selection> li > span': 'add_chart_item',
        ...
        edit_dashboard: function(){
            ...
            self.$(event.target).hide();
            self.$("#save_dashboard").css("display","inline-block");
